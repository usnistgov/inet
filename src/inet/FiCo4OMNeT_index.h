 ...
 * @verbinclude README
 *
 * @page install Install help
 * @verbinclude INSTALL
 */

/**
 * @mainpage Sourcecode Documentation - Fieldbus Communication for OMNeT++ (FiCo4OMNeT)
 *
 * This is the sourcecode documentation for the FiCo4OMNeT model.
 *
